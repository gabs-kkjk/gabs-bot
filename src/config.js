...
export const PREFIX = "Δ";

// Emoji do bot (mude se preferir).
export const BOT_EMOJI = "";

// Nome do bot (mude se preferir).
export const BOT_NAME = "GABS BOT";
...
export const SPIDER_API_TOKEN = "9HnEAoMZc6BXdmo57gV0";
...
export const LINKER_API_KEY = "S7isIoqP";
